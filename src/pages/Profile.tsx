...
const orderHistory = [
  {
    ...
    total: 1500000,
    items: [
      { id: '1', name: 'Silky Straight Bundle', price: 850000, quantity: 1, color: 'Black' },
      { id: '2', name: 'Body Wave Closure', price: 650000, quantity: 1, color: 'Dark Brown' },
    ],
  ...
  },
  {
    ...
    total: 920000,
    items: [
      { id: '3', name: 'Curly Lace Front Wig', price: 920000, quantity: 1, color: 'Light Brown' },
    ],
  ...
  },
  {
    ...
    total: 1460000,
    items: [
      { id: '4', name: 'Deep Wave Bundle', price: 780000, quantity: 1, color: 'Black' },
      { id: '5', name: 'Loose Wave Frontal', price: 680000, quantity: 1, color: 'Brown' },
    ],
