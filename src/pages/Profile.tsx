...
const orderHistory = [
  {
    ...
    total: 285000,
    items: [
      { id: '1', name: 'Silky Straight Bundle', price: 145000, quantity: 1, color: 'Black' },
      { id: '2', name: 'Body Wave Closure', price: 135000, quantity: 1, color: 'Dark Brown' },
    ],
  ...
  },
  {
    ...
    total: 155000,
    items: [
      { id: '3', name: 'Curly Lace Front Wig', price: 155000, quantity: 1, color: 'Light Brown' },
    ],
  ...
  },
  {
    ...
    total: 298000,
    items: [
      { id: '4', name: 'Deep Wave Bundle', price: 148000, quantity: 1, color: 'Black' },
      { id: '5', name: 'Loose Wave Frontal', price: 140000, quantity: 1, color: 'Brown' },
    ],
